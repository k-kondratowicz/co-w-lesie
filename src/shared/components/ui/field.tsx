...
function Field({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: semantic elements are provided by FieldSet and FieldLegend
    <div
      role="group"
      data-slot="field"
...
function FieldTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot="field-label"
      className={cn('flex w-fit items-center gap-2 font-medium text-sm group-data-[disabled=true]/field:opacity-50', className)}
      {...props}
    />
  );
}
  ...
  const content = useMemo(() => {
    ...
    return (
      <ul className="ml-4 flex list-disc flex-col gap-1">
        {/** biome-ignore lint/suspicious/noArrayIndexKey: no unique keys */}
