...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: This component is used as a wrapper for input and its addons, so it needs to be a div with role="group"
    <div
...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/useKeyWithClickEvents: This component is used as a wrapper for input and its addons, so it needs to be a div with role="group"
    // biome-ignore lint/a11y/useSemanticElements: This component is used as a wrapper for input and its addons, so it needs to be a div with role="group"
    <div
      role="group"
